...
#[command]
fn launch_game(game_id: String, game_title: String) -> Result<String, String> {
...
pub fn run() {
  tauri::Builder::default()
    .invoke_handler(tauri::generate_handler![launch_game, show_game_folder, check_game_installed])
    .setup(|app| {
